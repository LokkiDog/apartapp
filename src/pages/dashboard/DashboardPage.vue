...
<template>
  <section class="page-wrap space-y-6">
    ...
    <div v-else class="grid grid-cols-2 gap-3 lg:grid-cols-4">
      ...
      <NuxtLink v-if="canViewWork" to="/work" class="dashboard-metric-link"><MetricTile :label="t('dashboard.cleanings')" :value="openCleanings.length" icon="i-lucide-sparkles" /></NuxtLink>
