          ...
          <div class="manager-expense-toolbar border-b border-[var(--color-line)] p-4 sm:p-5">
            ...
            <div class="manager-expense-toolbar__controls">
              ...
              <div class="manager-expense-actions">
                <UDropdownMenu :items="addItems" :content="{ align: 'end' }"><UButton color="neutral" variant="outline" icon="i-lucide-plus" class="min-h-11 min-w-11 transition-transform active:scale-[0.96]" :aria-label="t('statementExtra.addExpense')" :title="t('statementExtra.addExpense')" /></UDropdownMenu>
