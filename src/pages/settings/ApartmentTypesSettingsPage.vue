...
function resetForm() { Object.assign(form, { name: '', cleanerPoolEur: 0, laundryEur: 0, serviceEur: 0, defaultChecklist: [...checklistTemplate.value] }) }
function openCreate() { typeToEdit.value = null; resetForm(); error.value = ''; open.value = true }
function openEdit(type: ApartmentType) { typeToEdit.value = type; Object.assign(form, { name: type.name, cleanerPoolEur: type.cleanerPoolEur, laundryEur: type.laundryEur, serviceEur: type.serviceEur, defaultChecklist: [...(type.defaultChecklist ?? checklistTemplate.value)] }); error.value = ''; open.value = true }
