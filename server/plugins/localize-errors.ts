...
const translations: Record<string, Partial<Record<ApiLocale, string>>> = {
  ...
  'Бронирование можно создать только для своего апартамента': { en: 'You can only create a booking for your own apartment', he: 'ניתן ליצור הזמנה רק עבור דירה שלך' },
  ...
  'Викой может быть только собственник или администратор вне архива': { en: 'Vika must be a non-archived owner or administrator', he: 'ויקטוריה חייבת להיות בעלת נכס או מנהלת מערכת שאינה בארכיון' },
