...
const apartments: Apartment[] = [
  { id: 'apartment-1', name: 'A1', internalCode: 'A1', building: '', locationDetails: '', status: 'active', hotel: { id: 'hotel-1', name: 'Hotel 1' }, manager: null },
  { id: 'apartment-2', name: 'A2', internalCode: 'A2', building: '', locationDetails: '', status: 'active', hotel: { id: 'hotel-2', name: 'Hotel 2' }, manager: null }
]
